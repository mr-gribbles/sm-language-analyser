...
try:
    ...
    print("=" * 80)
    print("ERROR: A critical error occurred while initializing the NLTK "
          "analyzer.")
    print("This is likely because the required NLTK data could not be "
          "downloaded.")
    print(f"The specific error was: {e}")
    print("\nTo fix this, please try the following steps:")
    print("1. Run the manual SSL certificate installer for Python "
          "(especially on macOS):")
    print("   - Open Finder -> Applications -> Python 3.11 (or your version)")
    print("   - Double-click on 'Install Certificates.command'")
    print("\n2. If that doesn't work, download all required data manually "
          "in your terminal:")
    print("   - Make sure your virtual environment is active.")
    print("   - Run the command: python -m nltk.downloader vader_lexicon "
          "punkt punkt_tab")
...
def analyze_readability(text: str) -> dict:
    ...
    Returns:
        dict: A dictionary containing the Flesch Reading Ease and Flesch-Kincaid
...
def analyze_lexical_diversity(text: str) -> dict:
    ...
    Returns:
        dict: A dictionary containing the TTR score. If the text is empty
...
def analyze_sentiment(text: str) -> dict:
    ...
    Returns:
        dict: A dictionary containing positive, negative, neutral, and compound
...
def run_full_analysis(text: str) -> dict:
    ...
    Returns:
        dict: A dictionary containing all analysis results: readability, lexical
