...
class SocialMediaCorpusGenerator:
    ...
    def get_social_media_prompts(self) -> List[Dict[str, Any]]:
        ...
        prompts = [
            # Twitter/X Style Posts
            {
                ...
                "template": (
                    "You are posting your opinion about {topic} on Twitter. Write a single "
                    "authentic tweet (under 280 characters) expressing your personal view."
                ),
                "topics": [
            ...
            },
            {
                ...
                "template": (
                    "You just heard about {topic}. Write a single Twitter post (under 280 "
                    "characters) reacting to this news with your immediate thoughts."
                ),
                "topics": [
            ...
            # Reddit Style Posts
            {
                ...
                "template": (
                    "You want to start a discussion about {topic} on Reddit. Write a post "
                    "that shares your thoughts and asks the community a genuine question. "
                    "100-300 words."
                ),
                "topics": [
            ...
            },
            {
                ...
                "template": (
                    "You want to share your experience with {topic} on Reddit. Write a "
                    "personal post telling your story authentically. 150-400 words."
                ),
                "topics": [
            ...
            # LinkedIn Style Posts
            {
                ...
                "template": (
                    "You're sharing your professional thoughts about {topic} on LinkedIn. "
                    "Write a thoughtful post that would resonate with your professional "
                    "network. 100-200 words."
                ),
                "topics": [
            ...
            },
            {
                ...
                "template": (
                    "You're posting on LinkedIn about trends you've noticed in {topic}. "
                    "Share your professional insights and analysis. 150-300 words."
                ),
                "topics": [
            ...
            # Instagram/Facebook Style Posts
            {
                ...
                "template": (
                    "You're posting on Instagram about {topic}. Share your personal "
                    "experience or thoughts in a lifestyle-focused way. Include "
                    "hashtags. 50-150 words."
                ),
                "topics": [
            ...
            },
            {
                ...
                "template": (
                    "You're posting in your local community Facebook group about {topic}. "
                    "Write something helpful and community-focused. 100-250 words."
                ),
                "topics": [
            ...
            # General Social Media Content
            {
                ...
                "template": (
                    "You want to share something motivational about {topic} on social "
                    "media. Write an inspiring post that encourages others. 50-150 words."
                ),
                "topics": [
            ...
            },
            {
                ...
                "template": (
                    "You want to help people understand {topic} better. Create a social "
                    "media post that explains it clearly and helpfully. 100-200 words."
                ),
                "topics": [
    ...
    def generate_social_media_post(
        self, prompt_info: Dict[str, Any], style: str
    ) -> str:
        ...
        generated_text = generate_text_with_gemini(
            prompt=full_prompt, model_name=self.model_name
        )

        return generated_text

    def create_corpus_entry(
        self, generated_text: str, prompt_info: Dict[str, Any], topic: str, style: str
    ) -> Dict[str, Any]:
        ...
        corpus_entry = {
            ...
            "original_content": {
                ...
                "author": "AI Generated",
                "platform": prompt_info["category"].split("_")[
                    0
    ...
    def generate_corpus(
        self, num_texts: int, output_dir: str, output_file: str, delay: float = 2.0
    ) -> int:
        ...
        for i in range(num_texts):
            try:
                ...
                if (
                    generated_text and len(generated_text.strip()) > 10
                ):  # Lower threshold for social media
                    # Create corpus entry
...
def main():
    """Run the main function for social media corpus generation."""
    ...
    try:
        ...
        if generated_count > 0:
            print("Social media corpus generation complete")
            print(
                f"Generated {generated_count} posts saved to: {args.output_dir}/{args.output_file}"
            )
        else:
            print("No posts were generated successfully")
